...
red_tshirt = Item.new(user: user)
red_tshirt.category = Category.all[0]
...
red_tshirt2 = Item.new(user: user)
red_tshirt2.category = Category.all[0]
...
red_shoes = Item.new(user: user)
red_shoes.category = Category.all[2]
...
red_nike = Item.new(user: user)
red_nike.category = Category.all[2]
...
blue_tshirt2 = Item.new(user: user)
blue_tshirt2.category = Category.all[0]
